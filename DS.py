...
os.system("espeak -a 300 \"Checking,Update,10.0\"")
time.sleep(2)
#os.system('clear')
print('\033[97;1m[\x1b[38;5;50m+\033[97;1m] \x1b[38;5;50mUPDATE VERSHON 10.0V...! ')
os.system("espeak -a 300 \"UPDATE VERSION 10.0,\"")
time.sleep(2)
#os.system('clear')
print("\033[97;1m[\x1b[38;5;50m+\033[97;1m]\x1b[38;5;50m FLOW MY FACEBOOK ACCOUNT ..!")
os.system("espeak -a 300 \"FLOW,MY,FACEBOOK,ACCOUNT,\"")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100048770417366/')
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100048770417366/')
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/profile.php?id=100048770417366')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\33[1;32m───────────────────────────────────────────────────
[] AUTHOR       :     PRINCE SHAMIM
[] TOOLS        :     FILE-CLONING
[] TYPE         :     PREMIUM
[] FACEBOOK     :     PRINCE SHAMIM
[] VERSION      :     10.0
\33[1;32m──────────────────────────────────────────────────""")
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/ShamimCyber/PAID74874/blob/main/Approval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      os.system("python SHAMIM-6-4V.py")
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801616923594?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
def menu():
    ...
    if ASHIK in ['111']:
        ...
        os.system('xdg-open https://https://github.com/ShamimCyber/PAID74874')
        os.system("python nono.py")
    elif ASHIK in ['3','03']:
        result()
    elif ASHIK in ['0']:
